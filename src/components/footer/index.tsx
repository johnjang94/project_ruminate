export default function Footer() {
  return (
    <footer className="bg-brand-green min-h-[600px] border-brand-brown border-t-[24px] -mt-[5%] z-50 skew-y-0 p-16 py-32">
      <div className="flex flex-col gap-6 text-neutral-50">
        ...
        <p>
          ...
          quasi dolorem esse Itaque consequatur esse quaerat libero vitae
          Praesentium voluptates accusamus sapiente ipsam repellat? Magni
